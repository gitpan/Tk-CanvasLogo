...
package Tk::CanvasLogo::Turtle;
	...
	##############################################
	# there are two versions of each LOGO command
	# _draw_CMD and _schd_CMD
	# the _draw_ version actually draws the action on canvas
	# the _schd_ version schedule the action and meters it out based on speed
	##############################################
